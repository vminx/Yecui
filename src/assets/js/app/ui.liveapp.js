...
*/
	...
	function init_pageH(){ //初始化高度
		...
		var page_h = fn_h();
		var m_h = $(".ui-liveapp-page").height();
	...
	function page_touchend(e){	
		...
		if(move){
			...
			//返回页面(移动失败)
				...
				position ? $(".ui-liveapp-page").eq(newM-1).animate({'top':-v_h},an_time,"easeOutSine") : $(".ui-liveapp-page").eq(newM-1).animate({'top':v_h},an_time,"easeOutSine");
